---
title: nginx 的配置文件nginx.conf配置详解
date: 2023-09-21 10:14:00
tags: ["Nginx", "Mac", "Web服务器", "macOS"]
categories: ["SoftWare", "Nginx"]
render_with_liquid: false
permalink: /posts/2023-09-21-nginx-的配置文件nginx-conf配置详解/
---

本文档介绍 nginx 的配置文件nginx.conf配置详解 的相关内容。
...
rewrite ^(.*)$ http://1.2.3.4:8080/face.jpg redirect;
