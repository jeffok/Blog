---
title: Ceph架构及性能优化
date: 2023-08-26 08:48:00
tags: ["存储", "Ceph", "RBD"]
categories: ["Ceph"]
render_with_liquid: false
permalink: /posts/2023-08-26-Ceph架构及性能优化/
---

本文档介绍 Ceph 架构及性能优化的各个方面。
...
交换机端需要支持该功能，系统网卡设置才有效果。配置文件追加 `MTU=9000`。
...
SSD 要用 noop，SATA/SAS 使用 deadline：
...
每个pool的PG=5000/5=1000，那么创建pool的时候就指定pg为1024
