...
permalink: /posts/2019-09-03-linux-系统-UDP-丢包问题分析思路/
---
...
![image](http://note.youdao.com/yws/res/8653/B26E61C20C4644528E3CA260EB7AB730)
...
```bash
[root@jeff-devops]# ifconfig eth0
...
...
```bash
[root@jeff-devops]# ethtool -S eth0 | grep rx_ | grep errors
     rx_crc_errors: 0
     rx_missed_errors: 0
...
```json
[root@jeff-devops]# ethtool -g eth0
...
```sql
[root@jeff-devops]# dropwatch -l kas
...
* [万兆网卡 RX DROP 率近 33%](https://www.v2ex.com/t/281482)
* https://www.v2ex.com/t/307630#reply13
