---
title: 修改 daemon 节点
date: 2019-05-12 19:11:00
tags: ["Filecoin", "Ubuntu", "Linux", "区块链", "版本控制"]
categories: ["Filecoin"]
render_with_liquid: false
permalink: /posts/2019-05-12-修改-daemon-节点/
---
...
![image](https://note.youdao.com/yws/res/11982/1E56127042934B19A91829D1BEFA0409)

`主 Daemon` 节点获得初始 `FIL` 之后，就可以停止了，目的是为了更新它的 `ListenAddress`，方便远程 `miner` 能够连接到它，如下图所示：

![image](https://note.youdao.com/yws/res/11984/2C6FBB0AE77E430AB6BC19522E1D8BA0)
...
![image](https://note.youdao.com/yws/res/11986/9596FE3B2B9240A68921D1E4B3F5B833)
...
![image](https://note.youdao.com/yws/res/11988/A06F6B5B3E91439A9E5AB7FC9646B4C5)
...
![image](https://note.youdao.com/yws/res/11990/2648174D9BD847308954A36EF1AC91D3)
...
![image](https://note.youdao.com/yws/res/11992/2031E5276007490692819D6A56B993AF)

更新完成之后，重新启动 `miner` 节点，如下图所示：

![image](https://note.youdao.com/yws/res/11994/6A033296BC0144CF951C2EF5787BEB67)

把 `miner` 节点放到后台执行之后，如果想要重新打开看一下，可以使用 `screen -r miner` 命令，如下图所示：

![image](https://note.youdao.com/yws/res/11997/1AD666D1AB6A4D7A946CCB7790C20E1D)
...
![image](https://note.youdao.com/yws/res/11999/90B7D3A0F75742A880B22FEBE87915ED)

手动导出 `FULLNODE_API_INFO` 可以使用脚本 [【start_miner_remote_daemon2.sh】](./scripts/start_miner_remote_daemon2.sh) 的前半部分功能，如下图所示：

![image](https://note.youdao.com/yws/res/12001/CB017B31AE62424E94BC11CE6FFA5A64)
...
![image](https://note.youdao.com/yws/res/12003/90D33E92761A49B8BF50D35DE15B8C35)
